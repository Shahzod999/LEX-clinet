      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Making legal documents accessible and understandable for everyone, regardless of language or background.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-100 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><Link href="/terms-of-use" className="hover:text-purple-600 transition-colors">Terms of Service</Link></li>
              <li><Link href="/support" className="hover:text-purple-600 transition-colors">Contact</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 text-center">
          <p className="text-gray-600">
            © 2025 LexHelps | Built to make law accessible.
          </p>
        </div>
      </div>
    </footer>
