...
with_node \
  ...
  --target "/Users/shahzod/Desktop/LEX-main/client/ios/Pods/Target Support Files/Pods-LexHelps/ExpoModulesProvider.swift" \
  --entitlement "/Users/shahzod/Desktop/LEX-main/client/ios/LexHelps/LexHelps.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-secure-store" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
